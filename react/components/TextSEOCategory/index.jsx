...
const TextSEOCategory = ({ imageSrc, titleSEO, description }) => {
  if (!description) {
    return null
  }
  ...
  useEffect(() => {
    if (descriptionRef.current) {
      setShowButton(descriptionRef.current.scrollHeight > 250);
    }
  }, []);
...
TextSEOCategory.schema = {
  type: 'object',
  title: 'Texto SEO - Desktop',
  description: 'Texto SEO - Desktop',
  properties: {
    imageSrc: {
      title: 'Imagem SEO',
      type: 'string',
