        ...
        (<>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36">
            ...
            <g id="Grupo_de_máscara_1" data-name="Grupo de máscara 1" transform="matrix(-1, -0.017, 0.017, -1, 1115.822, 1144.637)" clipPath="url(#clip-path)">
              <path id="Caminho_6649" data-name="Caminho 6649" d="M9,18.33a1.125,1.125,0,0,1,1.125-1.125H23.159l-4.831-4.828a1.126,1.126,0,0,1,1.593-1.593l6.75,6.75a1.125,1.125,0,0,1,0,1.593l-6.75,6.75a1.126,1.126,0,0,1-1.593-1.593l4.831-4.829H10.125A1.125,1.125,0,0,1,9,18.33Z" transform="translate(1098.999 1088.67)" fill="#000" fillRule="evenodd"/>
            </g>
          </svg>
        </>)
      : (
